...
// ✅ MODIFIED: Load treasury address from environment variable
...
  
  // Also check if treasury address is a placeholder
  const treasuryLoaded = !treasuryAddress.includes('PLACEHOLDER') &&
                         !treasuryAddress.includes('undefined') &&
                         treasuryAddress.startsWith('0x');

  if (hasRealValues && treasuryLoaded) {
    console.log('✅ Environment variables loaded successfully');
    console.log('   Treasury:', treasuryAddress); // Now logs the loaded address
...
  const errors: string[] = [];
  
  // Skip treasury validation if using placeholder (during build)
