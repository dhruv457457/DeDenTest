...
function SignInForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#E7E4DF] p-4 relative overflow-hidden w-full h-full">
      {/* --- Sign-In Card Layout --- */}
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-[#172a46] rounded-2xl shadow-2xl z-10 overflow-hidden">
        
        {/* --- MODIFIED: LEFT COLUMN (Branding, Title, Error) --- */}
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <Link href="/" className="mb-8 block">
            <Image
              src="/images/logo-no-bg.png" // From HomePage footer
              alt="DEDEN Logo"
              width={180}
              height={64}
              className="h-16 w-auto" // Auto width, fixed height
              priority
            />
          </Link>

          {/* --- MOVED: Title & Subtitle ARE NOW HERE --- */}
          <h1 className="font-berlin text-4xl md:text-5xl font-bold text-white mb-4">
            {title}
          </h1>
